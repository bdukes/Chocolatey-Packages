...
$url = 'http://www.imagemagick.org/download/binaries/ImageMagick-6.9.1-9-portable-Q16-x86.zip'
$url64 = 'http://www.imagemagick.org/download/binaries/ImageMagick-6.9.1-9-portable-Q16-x64.zip'
