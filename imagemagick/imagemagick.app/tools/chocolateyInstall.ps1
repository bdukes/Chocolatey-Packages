...
$installerType = 'exe'
$url = 'http://www.imagemagick.org/download/binaries/ImageMagick-6.9.3-5-Q16-x86-dll.exe'
$url64 = 'http://www.imagemagick.org/download/binaries/ImageMagick-6.9.3-5-Q16-x64-dll.exe'
...
try {
    ...
    $url = 'http://ftp.icm.edu.pl/pub/graphics/ImageMagick/binaries/ImageMagick-6.9.3-5-Q16-x86-dll.exe'
    $url64 = 'http://ftp.icm.edu.pl/pub/graphics/ImageMagick/binaries/ImageMagick-6.9.3-5-Q16-x64-dll.exe'
    Install-ChocolateyPackage "$packageName" "$installerType" "$silentArgs" "$url" "$url64"  -validExitCodes $validExitCodes
}