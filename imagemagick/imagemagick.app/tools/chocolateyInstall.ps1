$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://www.imagemagick.org/download/binaries/ImageMagick-6.9.6-2-Q16-x86-dll.exe'
  url64          = 'https://www.imagemagick.org/download/binaries/ImageMagick-6.9.6-2-Q16-x64-dll.exe'
  checksum       = '9A67B7629B32E3C88A24C92AC03B93ED52216EF713B7DD28DE89CF2A6C0CD272'
  checksum64     = '0328D3AB90BC7355A8636D1AAFBCB80021871115E7E79506CA046239CAA2A137'
  checksumType   = 'sha256'
