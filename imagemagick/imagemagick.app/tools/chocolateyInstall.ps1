...
$installerType = 'exe'
$url = 'http://www.imagemagick.org/download/binaries/ImageMagick-6.8.8-5-Q8-x86-dll.exe' # they did not release a Q16 x86 package for 6.8.8-5
$url64 = 'http://www.imagemagick.org/download/binaries/ImageMagick-6.8.8-5-Q16-x64-dll.exe'
