$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://imagemagick.org/download/binaries/ImageMagick-7.0.8-61-Q16-x86-dll.exe'
  url64          = 'https://imagemagick.org/download/binaries/ImageMagick-7.0.8-61-Q16-x64-dll.exe'
  checksum       = '392b522674ab9baaa9cade65a1854c492afe7826fd6eb825d48bd2afc87ed04c'
  checksum64     = 'e29225c1c09be2437bb30d8f3fbf086935e351862dc520a872bec95793ea7602'
  checksumType   = 'sha256'
