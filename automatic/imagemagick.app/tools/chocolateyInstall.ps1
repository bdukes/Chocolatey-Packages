$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://imagemagick.org/download/binaries/ImageMagick-7.0.9-10-Q16-x86-dll.exe'
  url64          = 'https://imagemagick.org/download/binaries/ImageMagick-7.0.9-10-Q16-x64-dll.exe'
  checksum       = '2674eed969b8a93771780d0bab291f8f17e4cd97c29dbb15d9a2fff2b2e7da0c'
  checksum64     = '640f262769db7b3f6a13f5a289334291cda208c6661e8ce4e46317cd7065286a'
  checksumType   = 'sha256'
