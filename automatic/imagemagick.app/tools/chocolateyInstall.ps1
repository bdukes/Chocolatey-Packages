$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://imagemagick.org/download/binaries/ImageMagick-7.0.9-0-Q16-x86-dll.exe'
  url64          = 'https://imagemagick.org/download/binaries/ImageMagick-7.0.9-0-Q16-x64-dll.exe'
  checksum       = 'a3e918445bcc04c6a67c27cd47f433bb6691a1333a84bfd1add73fb7359f313e'
  checksum64     = 'e40f7cdde1312033a426aa38ff1b7f76fb3e7f95a31f47825c06df094f66c724'
  checksumType   = 'sha256'
