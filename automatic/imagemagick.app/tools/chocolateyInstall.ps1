$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://imagemagick.org/download/binaries/ImageMagick-7.0.10-16-Q16-x86-dll.exe'
  url64          = 'https://imagemagick.org/download/binaries/ImageMagick-7.0.10-16-Q16-x64-dll.exe'
  fallbackUrl    = 'https://ftp.icm.edu.pl/pub/graphics/ImageMagick/binaries/ImageMagick-7.0.10-16-Q16-x86-dll.exe'
  fallbackUrl64  = 'https://ftp.icm.edu.pl/pub/graphics/ImageMagick/binaries/ImageMagick-7.0.10-16-Q16-x64-dll.exe'
  checksum       = '61593cded15bb0d003197620a34ddd243d713c074b05b3986a2e05c48a53502a'
  checksum64     = 'dc96ee898db8f0bf96a143fc5a6e777738b785fc8586416146ec9dec71ababe9'
  checksumType   = 'sha256'
