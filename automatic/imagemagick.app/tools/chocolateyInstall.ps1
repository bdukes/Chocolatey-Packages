$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://www.imagemagick.org/download/binaries/ImageMagick-7.0.6-5-Q16-x86-dll.exe'
  url64          = 'https://www.imagemagick.org/download/binaries/ImageMagick-7.0.6-5-Q16-x64-dll.exe'
  checksum       = 'fbc6fbcc12e8dfecf5fc8d4ef770b2587387f1b2963588ef1415b36396387ba5'
  checksum64     = 'c1056c5d101a8cde884337a228284a0b7d69dbb64dfd3ebe01f033f2f70e8832'
  checksumType   = 'sha256'
