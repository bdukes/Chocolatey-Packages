$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://imagemagick.org/download/binaries/ImageMagick-6.9.10-92-Q16-x86-dll.exe'
  url64          = 'https://imagemagick.org/download/binaries/ImageMagick-6.9.10-92-Q16-x64-dll.exe'
  checksum       = '6fceabe0810069c7696c4932adc541badceed147f732359d71ccbb74176165a9'
  checksum64     = '6a46a5da97b6661bdc8e07fa5e2920b5bcf7acd6ad7ec46f3057f0311f69ebcf'
  checksumType   = 'sha256'
