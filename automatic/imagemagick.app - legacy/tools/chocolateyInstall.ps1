$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://imagemagick.org/download/binaries/ImageMagick-6.9.11-9-Q16-x86-dll.exe'
  url64          = 'https://imagemagick.org/download/binaries/ImageMagick-6.9.11-9-Q16-x64-dll.exe'
  fallbackUrl    = 'https://ftp.icm.edu.pl/pub/graphics/ImageMagick/binaries/ImageMagick-6.9.11-9-Q16-x86-dll.exe'
  fallbackUrl64  = 'https://ftp.icm.edu.pl/pub/graphics/ImageMagick/binaries/ImageMagick-6.9.11-9-Q16-x64-dll.exe'
  checksum       = 'a0ae96066abf7200ce208ea937f8c387156901771102b87057aebb443615d71e'
  checksum64     = 'e0cdf72d1b37e6a80dbcd555b1c1a02ba7caeb1c7ba5c41581eef2688e8a6e2c'
  checksumType   = 'sha256'
