$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://www.imagemagick.org/download/binaries/ImageMagick-6.9.9-35-Q16-x86-dll.exe'
  url64          = 'https://www.imagemagick.org/download/binaries/ImageMagick-6.9.9-35-Q16-x64-dll.exe'
  checksum       = 'ee0b0b0031d7f0db7cf74df630fee79bef1156318225a52afefcac1ecbb15bf0'
  checksum64     = 'b7c70ca44573e5c427b759c306dd354a073803a1c847823cbcb7b3abc9fbcd97'
  checksumType   = 'sha256'
