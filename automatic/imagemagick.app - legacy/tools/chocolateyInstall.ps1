$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://imagemagick.org/download/binaries/ImageMagick-6.9.10-95-Q16-x86-dll.exe'
  url64          = 'https://imagemagick.org/download/binaries/ImageMagick-6.9.10-95-Q16-x64-dll.exe'
  checksum       = '452eeb754d3481b0975f8783f6ee3376bbc88813ee60660e5ecca0a4d6df42f6'
  checksum64     = 'bdc7e1e210d7ae197eabcb085d8a01220b91a9b60fcbaffafe01543fc87bd162'
  checksumType   = 'sha256'
