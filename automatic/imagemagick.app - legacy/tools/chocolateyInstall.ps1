$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://imagemagick.org/download/binaries/ImageMagick-6.9.11-20-Q16-x86-dll.exe'
  url64          = 'https://imagemagick.org/download/binaries/ImageMagick-6.9.11-20-Q16-x64-dll.exe'
  fallbackUrl    = 'https://ftp.icm.edu.pl/pub/graphics/ImageMagick/binaries/ImageMagick-6.9.11-20-Q16-x86-dll.exe'
  fallbackUrl64  = 'https://ftp.icm.edu.pl/pub/graphics/ImageMagick/binaries/ImageMagick-6.9.11-20-Q16-x64-dll.exe'
  checksum       = '4227e7cfe94d96f347f2a3ebadc2573c9886ec7e5f32ebb1590723ce48dad915'
  checksum64     = '7ac9677a6f0eb81943511f8e539686ccad513fe4535579754227ff30ad69cfe0'
  checksumType   = 'sha256'
