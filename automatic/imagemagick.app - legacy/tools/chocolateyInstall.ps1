$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://imagemagick.org/download/binaries/ImageMagick-6.9.11-7-Q16-x86-dll.exe'
  url64          = 'https://imagemagick.org/download/binaries/ImageMagick-6.9.11-7-Q16-x64-dll.exe'
  fallbackUrl    = 'https://ftp.icm.edu.pl/pub/graphics/ImageMagick/binaries/ImageMagick-6.9.11-7-Q16-x86-dll.exe'
  fallbackUrl64  = 'https://ftp.icm.edu.pl/pub/graphics/ImageMagick/binaries/ImageMagick-6.9.11-7-Q16-x64-dll.exe'
  checksum       = '4f829cb387a573832349157dfe94cfcf42967a1e79717185ccbf788087eda23f'
  checksum64     = '5155fa5fa3090002bcb418d21fb5a4cbba811f7c37d0eeddd8ea0584fcec17a9'
  checksumType   = 'sha256'
