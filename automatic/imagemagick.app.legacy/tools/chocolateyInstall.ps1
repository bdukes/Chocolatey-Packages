$packageArgs = @{
  ...
  installerType  = 'exe'
  url            = 'https://www.imagemagick.org/download/binaries/ImageMagick-6.9.7-9-Q16-x86-dll.exe'
  url64          = 'https://www.imagemagick.org/download/binaries/ImageMagick-6.9.7-9-Q16-x64-dll.exe'
  checksum       = 'c9b59ea102713dc8fe6d8f1c837121f0be5bb64cd0dc09141d5e20611e6ec5cf'
  checksum64     = 'f51fc078b4ff5584d7e48c0a723c2b3588013130ef4ce67262cfc1ccb425c1e2'
  checksumType   = 'sha256'
